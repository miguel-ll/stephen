...
#screen = Entry(b, width=120, borderwidth=3)
screen = Entry(b, font=('Calibri 14'),borderwidth=3)
#screen.place(x=50, y=80)
screen.place(width=900,height=40,x=50, y=60)
...
bs_button = Button(b, text="Backspace", bg="gray", fg="black", activebackground="red", activeforeground="gray",
...
shift_say = Button(b, text="Say", bg="gray", fg="red", activebackground="red", activeforeground="gray",
                    padx=30, pady=5, relief=RIDGE, command=say)
shift_say.place(x=550, y=290)
